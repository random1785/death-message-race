...
give @a oak_log 16
give @a iron_block
give @a echo_shard[consumable={consume_seconds:1.6,animation:"brush",sound:"block.beacon.activate"},item_name={"bold":true,"color":"gold","text":"Spawnpoint Setter"},enchantment_glint_override=true] 64
