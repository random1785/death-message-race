# death-message-race
Minecraft Datapack where players need to race each other to get different death messages! Works on 1.21.5-1.21.7. will not be updated further due to the mod not working on later versions.
